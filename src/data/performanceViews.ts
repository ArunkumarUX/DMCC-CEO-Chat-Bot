...
const ESCALATION_DEFS: {
  ...
  },
  {
    ...
    deptId: 'legal',
    icon: 'scale',
    titleEn: 'UAE retail compliance rental disclosure filing due in 11 days',
    titleAr: 'إيداع UAE retail compliance للإيجار مستحق خلال 11 يوماً',
    sev: 'High',
  },
  {
    id: 'esc-sales',
    deptId: 'sales',
    icon: 'target',
    titleEn: 'AED 90M 6thStreet pre-sales deal stalled',
    titleAr: 'صفقة مبيعات 6thStreet 90M درهم متوقفة',
    sev: 'Medium',
  },
];
