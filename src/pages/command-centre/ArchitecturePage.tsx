    ...
    <IntelCard>
      <IntelCardBody>
        ...
        <div style={{ background: 'var(--surface-2)', border: '1px solid var(--line)', borderRadius: 14, padding: 18, marginTop: 4 }}>
          ...
          <div className="type-title" style={{ fontSize: 16, marginBottom: 18 }}>{ar ? '«جهّز لي إحاطة عن اجتماع وفد سنغافورة MAS غداً».' : '"Brief me on tomorrow\'s meeting with the Singapore MAS delegation."'}</div>
